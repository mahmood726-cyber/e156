...
trial counts (African-site NTD/HIV/cancer/CVD totals and shares) are regenerated by
`40-ntd-verify.py` against the AACT April-12-2026 snapshot; cited literature numerals
(Pedrique/Trouiller figures, v1 comparison counts, PMID-audit counts) and burden
percentages are AS-CITED to their sources, not script-regenerated (burden pending
primary GBD extraction). According to PubMed metadata, every retained PMID was verified
by title/journal/pages match on 2026-07-09.*
